...
const tasks = [
  ...
  {
    id: 4,
    title: "Войти на стажировку в компанию",
    date: "30.10.2026",
    complited: false,
  },
];
          ...
          {tasks.map((task) => (
            <Col xs={24} sm={12} md={8} key={task.id}>
              <Card
                ...
                style={{
                  boxShadow: isDark
                    ? "1px 2px 4px rgba(167, 67, 203, 0.9)"
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = task.complited
                    ? "scale(0.95)"
                    : "scale(1.05)";
                }}
                onMouseLeave={(e) => {
              ...
              >
                ...
                {!task.complited && (
                  <Button
                    type="primary"
                    onClick={() => alert("Задача выполнена!")}
                  >
                    Done
                  </Button>
                )}
